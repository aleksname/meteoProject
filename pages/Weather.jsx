...
import mainBackground from './components/img/Weather/mainBackground2.png';
...
export default function Weather() {
  ...
  return (
    <MainContainter titels='Weather page' className={styles.weatherPage} style={{ backgroundImage: `url(${mainBackground})` }}>
